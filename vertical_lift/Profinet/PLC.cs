        ...
        public object Read(string variable)
        {
            ...
            try
            {
                switch (txt.Substring(0, 2))
                {
                    ...
                    case "MW":
                        // Merkerwort
                        int nn = int.Parse(txt.Substring(2));
                    ...
                    default:
                        ...
                        if (mBit > 7) throw new Exception();
                        mBit1 = Convert.ToInt32(Read(mDataType, 0, mByte, VarType.Byte, 1)).ToString();
                        //objBoolArray = (sbyte[])Read(mDataType, 0, mByte, VarType.Byte, 1);                        
                        //return objBoolArray[mBit];
                        return mBit1;
                }
            }
